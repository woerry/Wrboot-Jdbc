...
public class DateUtil {
    ...
    /**
     * 获取当前时间。
     * @param format 如果为null,则默认yyyy-MM-dd HH:mm:ss 格式
     * @return
     */
...
//System.out.println(24*60*60*1000L);
     ...
     * @return
     */
    public static String getManyDaysAgo(String format,int days){
        Date today = new Date();
        String d="";
        Date yesterday = new Date(today.getTime() - 86400000L*days);//86400000L，它的意思是说1天的时间=24小时 x 60分钟 x 60秒 x 1000毫秒 单位是L。
//即86400000L可用写成 24*60*60*1000L
//System.out.println(24*60*60*1000L);
        if(format!=null&&!format.equals("")){
            d=format;
     ...
     * @return
     */
    public static String getManyDaysAfter(String format,int days){
        Date today = new Date();
        String d="";
        Date yesterday = new Date(today.getTime() + 86400000L*days);//86400000L，它的意思是说1天的时间=24小时 x 60分钟 x 60秒 x 1000毫秒 单位是L。
//即86400000L可用写成 24*60*60*1000L
//System.out.println(24*60*60*1000L);
     ...
     * @return 格式化后的Date日期
     */
    public static Timestamp parseStrToTimestamp(String time) {
        if (time == null || time.equals("")) {
            return null;
        }
